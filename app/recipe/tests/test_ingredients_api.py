...
class PublicIngredientsApiTests(TestCase):
    ...
    def test_login_required(self):
        """Test that login is required to access then endpoint"""
...
class PrivateIngredientApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        """test that only users ingredients are returned"""
        ...
        ingredient = Ingredient.objects.create(user=self.user, name='Temeric')
    ...
    def test_create_ingredient_invalid(self):
        """Test creating with invalid payload fails"""
        payload = {'name': ''}
