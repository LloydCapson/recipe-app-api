...
def sample_tag(user, name='Sample Tag Name'):
    """Create and return a sample tag"""
    return Tag.objects.create(user=user, name=name)


def sample_ingredient(user, name='Sample Ingredient Name'):
...
class PrivateRecipeApiTests(TestCase):
    """Test authenticated recpie api access"""
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipes_by_tags(self):
        """Test returning recipes based on tag"""
        recipe1 = sample_recipe(user=self.user, title='First')
        recipe2 = sample_recipe(user=self.user, title='Second')
        tag1 = sample_tag(user=self.user, name='tag1')
        tag2 = sample_tag(user=self.user, name='tag2')
        recipe1.tags.add(tag1)
        recipe2.tags.add(tag2)
        recipe3 = sample_recipe(user=self.user, title='Third')
    ...
    def test_filter_recipes_by_ingredients(self):
        """Test returning recipes based on ingredient"""
